...
import { useSSRContext, defineComponent, ref, withCtx, createTextVNode, unref, toDisplayString, createVNode, openBlock, createBlock, Fragment, renderList, createCommentVNode, Transition } from 'vue';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const { data: hotposts } = useAsyncData(
      "hotposts",
      () => $fetch("http://localhost:3001/api/post/gethot", {
        method: "GET",
        credentials: "include",
        key: "hotposts"
      })
    ...
    {
      console.log("server1:", hotposts);
    }
    const { data: posts } = useAsyncData(
      "posts",
      () => $fetch(`http://localhost:3001/api/post/get?currentPage=${currentPage.value}&keyWord=${searchInput.value}&type=${selectCategory.value}`, {
        method: "GET",
        credentials: "include",
        key: "posts"
      }),
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-8fc156f1>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<aside data-v-8fc156f1${_scopeId2}><h1 data-v-8fc156f1${_scopeId2}>NYKnow.com</h1>`);
                  if (!isLogin.value) {
                  ...
                  _push3(`<span data-v-8fc156f1${_scopeId2}></span>`);
                  if (!isLogin.value) {
                    _push3(ssrRenderComponent(_component_el_button, {
                      plain: "",
                      style: { "width": "100%", "margin-top": "10px" },
                  ...
                  _push3(`<span data-v-8fc156f1${_scopeId2}> \u5728\u6B64\u8F93\u5165\u5E16\u5B50\u7684\u6807\u9898\u548C\u5206\u7C7B,\u5206\u7C7B\u53EF\u4EE5\u4E0D\u9009\u6216\u9009\u62E9&#39;\u4E0D\u9009&#39;\u8FD9\u4E2A\u9009\u9879(\u9ED8\u8BA4) </span><div data-v-8fc156f1${_scopeId2}>`);
                  ...
                  _push3(`</div><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" style="${ssrRenderStyle({ "width": "20px", "vertical-align": "bottom" })}" data-v-8fc156f1${_scopeId2}><path fill="currentColor" d="M704 192h160v736H160V192h160v64h384zM288 512h448v-64H288zm0 256h448v-64H288zm96-576V96h256v96z" data-v-8fc156f1${_scopeId2}></path></svg><span data-v-8fc156f1${_scopeId2}>\u6700\u70ED\u5E16\u5B50</span><div class="latestPost" data-v-8fc156f1${_scopeId2}><ul data-v-8fc156f1${_scopeId2}><!--[-->`);
                  ssrRenderList(unref(hotposts).data, (post) => {
                    _push3(`<li data-v-8fc156f1${_scopeId2}>`);
                  ...
                  _push3(`<!--]--></ul></div><span data-v-8fc156f1${_scopeId2}>\u516C\u544A</span><div data-v-8fc156f1${_scopeId2}>`);
                  _push3(ssrRenderComponent(_component_el_card, { shadow: "always" }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`<p data-v-8fc156f1${_scopeId3}>\u672C\u7AD9\u65E8\u5728\u5EFA\u7ACB\u4E00\u4E2A\u53EF\u7528\u4E8E\u4EA4\u6D41\u7684\u793E\u533A\uFF0C\u4F60\u53EF\u4EE5\u4EE5\u6E38\u5BA2\u7684\u65B9\u5F0F\u6D4F\u89C8\u5185\u5BB9\u6216\u662F\u521B\u5EFA\u4E00\u4E2A\u8D26\u6237\u6765\u53D1\u8868\u5E16\u5B50\uFF0C\u4F46\u7981\u6B62\u53D1\u5E03\u8FB1\u9A82\u7B49\u654F\u611F\u8BCD\u6C47\uFF0C\u611F\u8C22\u5927\u5BB6\u7684\u914D\u5408</p>`);
                      } else {
                        return [
                  ...
                  _push3(`</div><div style="${ssrRenderStyle({ "height": "1px" })}" data-v-8fc156f1${_scopeId2}></div></aside><header data-v-8fc156f1${_scopeId2}>`);
                      ...
                      if (_push4) {
                        _push4(ssrRenderComponent(_component_el_menu_item, { index: "1" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" data-v-ea893728="" style="${ssrRenderStyle({ "width": "24px" })}" data-v-8fc156f1${_scopeId4}><path fill="currentColor" d="M192 413.952V896h640V413.952L512 147.328zM139.52 374.4l352-293.312a32 32 0 0 1 40.96 0l352 293.312A32 32 0 0 1 896 398.976V928a32 32 0 0 1-32 32H160a32 32 0 0 1-32-32V398.976a32 32 0 0 1 11.52-24.576" data-v-8fc156f1${_scopeId4}></path></svg><span style="${ssrRenderStyle({ "padding-left": "5px" })}" data-v-8fc156f1${_scopeId4}> \u9996\u9875 </span>`);
                            } else {
                              return [
                        ...
                        _push4(`<div class="flex-grow" data-v-8fc156f1${_scopeId3}></div>`);
                        _push4(ssrRenderComponent(_component_el_menu_item, { index: "2" }, {
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" data-v-ea893728="" style="${ssrRenderStyle({ "width": "24px" })}" data-v-8fc156f1${_scopeId4}><path fill="currentColor" d="m795.904 750.72 124.992 124.928a32 32 0 0 1-45.248 45.248L750.656 795.904a416 416 0 1 1 45.248-45.248zM480 832a352 352 0 1 0 0-704 352 352 0 0 0 0 704" data-v-8fc156f1${_scopeId4}></path></svg><span style="${ssrRenderStyle({ "padding-left": "5px", "padding-right": "15px" })}" data-v-8fc156f1${_scopeId4}>\u641C\u7D22</span>`);
                            } else {
                              return [
                                (openBlock(), createBlock("svg", {
                                  xmlns: "http://www.w3.org/2000/svg",
                        ...
                        if (!isLogin.value) {
                          _push4(ssrRenderComponent(_component_el_menu_item, { index: "3" }, {
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" data-v-ea893728="" style="${ssrRenderStyle({ "width": "24px" })}" data-v-8fc156f1${_scopeId4}><path fill="currentColor" d="M512 512a192 192 0 1 0 0-384 192 192 0 0 0 0 384m0 64a256 256 0 1 1 0-512 256 256 0 0 1 0 512m320 320v-96a96 96 0 0 0-96-96H288a96 96 0 0 0-96 96v96a32 32 0 1 1-64 0v-96a160 160 0 0 1 160-160h448a160 160 0 0 1 160 160v96a32 32 0 1 1-64 0" data-v-8fc156f1${_scopeId4}></path></svg><span style="${ssrRenderStyle({ "padding-left": "5px" })}" data-v-8fc156f1${_scopeId4}>\u6CE8\u518C/\u767B\u5F55</span>`);
                              } else {
                                return [
                                  (openBlock(), createBlock("svg", {
                                    xmlns: "http://www.w3.org/2000/svg",
                          ...
                          _push4(ssrRenderComponent(_component_el_sub_menu, {
                            ...
                            title: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              var _a, _b;
                              if (_push5) {
                                _push5(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" data-v-ea893728="" style="${ssrRenderStyle({ "width": "24px" })}" data-v-8fc156f1${_scopeId4}><path fill="currentColor" d="M512 512a192 192 0 1 0 0-384 192 192 0 0 0 0 384m0 64a256 256 0 1 1 0-512 256 256 0 0 1 0 512m320 320v-96a96 96 0 0 0-96-96H288a96 96 0 0 0-96 96v96a32 32 0 1 1-64 0v-96a160 160 0 0 1 160-160h448a160 160 0 0 1 160 160v96a32 32 0 1 1-64 0" data-v-8fc156f1${_scopeId4}></path></svg><span style="${ssrRenderStyle({ "padding-left": "5px" })}" data-v-8fc156f1${_scopeId4}>${ssrInterpolate((_a = unref(userStore).userInfo) == null ? void 0 : _a.username)}</span>`);
                              } else {
                                return [
                                  (openBlock(), createBlock("svg", {
                                    xmlns: "http://www.w3.org/2000/svg",
                  ...
                  if (showSearchBox.value) {
                    _push3(`<div class="searchBox" data-v-8fc156f1${_scopeId2}>`);
                    _push3(ssrRenderComponent(_component_el_input, {
                      modelValue: searchInput.value,
                      "onUpdate:modelValue": ($event) => searchInput.value = $event,
                      placeholder: "\u8F93\u5165\u5173\u952E\u8BCD",
            ...
            _push2(ssrRenderComponent(_component_el_col, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<main data-v-8fc156f1${_scopeId2}><!--[-->`);
                  ssrRenderList(unref(posts).data.result, (post) => {
                    _push3(ssrRenderComponent(_component_NuxtLink, {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        var _a;
                        if (_push4) {
                          _push4(`<div data-v-8fc156f1${_scopeId3}>`);
                          _push4(ssrRenderComponent(_component_el_avatar, {
                            ...
                            default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                              if (_push5) {
                                _push5(`<img${ssrRenderAttr("src", _imports_0)} data-v-8fc156f1${_scopeId4}>`);
                              } else {
                                return [
                          ...
                          _push4(`<span data-v-8fc156f1${_scopeId3}>${ssrInterpolate(post.username)}</span><h4 data-v-8fc156f1${_scopeId3}>${ssrInterpolate(post.title)}</h4><p class="content" style="${ssrRenderStyle({ "width": "100%", "margin-bottom": "5px" })}" data-v-8fc156f1${_scopeId3}>${(_a = post.content) != null ? _a : ""}</p><span data-v-8fc156f1${_scopeId3}>${ssrInterpolate(post.createdAt.split("T")[0])}</span><span style="${ssrRenderStyle({ "float": "right" })}" data-v-8fc156f1${_scopeId3}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" data-v-ea893728="" style="${ssrRenderStyle({ "width": "20px", "vertical-align": "text-bottom" })}" data-v-8fc156f1${_scopeId3}><path fill="currentColor" d="m174.72 855.68 135.296-45.12 23.68 11.84C388.096 849.536 448.576 864 512 864c211.84 0 384-166.784 384-352S723.84 160 512 160 128 326.784 128 512c0 69.12 24.96 139.264 70.848 199.232l22.08 28.8-46.272 115.584zm-45.248 82.56A32 32 0 0 1 89.6 896l58.368-145.92C94.72 680.32 64 596.864 64 512 64 299.904 256 96 512 96s448 203.904 448 416-192 416-448 416a461.056 461.056 0 0 1-206.912-48.384l-175.616 58.56z" data-v-8fc156f1${_scopeId3}></path><path fill="currentColor" d="M512 563.2a51.2 51.2 0 1 1 0-102.4 51.2 51.2 0 0 1 0 102.4m192 0a51.2 51.2 0 1 1 0-102.4 51.2 51.2 0 0 1 0 102.4m-384 0a51.2 51.2 0 1 1 0-102.4 51.2 51.2 0 0 1 0 102.4" data-v-8fc156f1${_scopeId3}></path></svg> ${ssrInterpolate(post.comments)} <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024" data-v-ea893728="" style="${ssrRenderStyle({ "width": "20px", "vertical-align": "text-bottom" })}" data-v-8fc156f1${_scopeId3}><path fill="currentColor" d="M512 160c320 0 512 352 512 352S832 864 512 864 0 512 0 512s192-352 512-352m0 64c-225.28 0-384.128 208.064-436.8 288 52.608 79.872 211.456 288 436.8 288 225.28 0 384.128-208.064 436.8-288-52.608-79.872-211.456-288-436.8-288zm0 64a224 224 0 1 1 0 448 224 224 0 0 1 0-448m0 64a160.192 160.192 0 0 0-160 160c0 88.192 71.744 160 160 160s160-71.808 160-160-71.744-160-160-160" data-v-8fc156f1${_scopeId3}></path></svg> ${ssrInterpolate(post.visitors)}</span></div>`);
                        } else {
                          return [
                            createVNode("div", null, [
      ...
      _push(` ${ssrInterpolate(unref(posts))}</div>`);
    };
  }
});
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8fc156f1"]]);

export { index as default };
//# sourceMappingURL=index-ftM2DrVu.mjs.map
